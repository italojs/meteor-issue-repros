    ...
    return {
        ...
        check ({ moduleGraph, report, ruleConfig }) {
            ...
            for (const { dependency, node } of dependencyWithNode){
                ...
                if (canFix) {
                    const fixData = (0, external_utils_cjs_namespaceObject.getFixData)(dependency.module, node, document.range);
                    const detail = {
                        type: 'code-change',
                        file: {
                            path: document.path,
