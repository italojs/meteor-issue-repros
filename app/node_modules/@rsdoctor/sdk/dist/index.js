...
import __rslib_shim_module__, { createRequire as __rspack_createRequire } from "node:module";
...
import path_0, { join as external_path_join, resolve as external_path_resolve } from "path";
...
import { EnvInfo, File, Json, Server } from "@rsdoctor/utils/build";
import node_path, { join, normalize, resolve as external_node_path_resolve, sep as external_node_path_sep, dirname as __rspack_dirname } from "node:path";
...
__webpack_require__.add({
    ...
    "../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/read.js" (module, __unused_rspack_exports, __webpack_require__) {
        var createError = __webpack_require__("../../node_modules/.pnpm/http-errors@2.0.1/node_modules/http-errors/index.js"), getBody = __webpack_require__("../../node_modules/.pnpm/raw-body@3.0.2/node_modules/raw-body/index.js"), iconv = __webpack_require__("../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/index.js"), onFinished = __webpack_require__("../../node_modules/.pnpm/on-finished@2.4.1/node_modules/on-finished/index.js"), zlib = __webpack_require__("node:zlib"), hasBody = __webpack_require__("../../node_modules/.pnpm/type-is@2.0.1/node_modules/type-is/index.js").hasBody, { getCharset } = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/utils.js");
        module.exports = function(req, res, next, parse, debug, options) {
            if (onFinished.isFinished(req)) {
                debug('body already parsed'), next();
                return;
            }
            if ('body' in req || (req.body = void 0), !hasBody(req)) {
                debug('skip empty body'), next();
                return;
            }
            if (debug('content-type %j', req.headers['content-type']), !options.shouldParse(req)) {
                debug('skip parsing'), next();
                return;
            }
            var length, stream, encoding = null;
            if (options?.skipCharset !== !0 && (encoding = getCharset(req) || options.defaultCharset, options?.isValidCharset && !options.isValidCharset(encoding))) {
                debug('invalid charset'), next(createError(415, 'unsupported charset "' + encoding.toUpperCase() + '"', {
                    charset: encoding,
            ...
            try {
                length = (stream = function(req, debug, inflate) {
                    var encoding = (req.headers['content-encoding'] || 'identity').toLowerCase(), length = req.headers['content-length'];
                    if (debug('content-encoding "%s"', encoding), !1 === inflate && 'identity' !== encoding) throw createError(415, 'content encoding unsupported', {
                        encoding: encoding,
                        type: 'encoding.unsupported'
                    });
                    if ('identity' === encoding) return req.length = length, req;
                    var stream = function(encoding, debug) {
                        switch(encoding){
                            case 'deflate':
                                return debug('inflate body'), zlib.createInflate();
                            case 'gzip':
                                return debug('gunzip body'), zlib.createGunzip();
                            case 'br':
                                return debug('brotli decompress body'), zlib.createBrotliDecompress();
                            default:
            ...
            debug('read body'), getBody(stream, options, function(error, body) {
                if (error) {
                    ...
                    _error = 'encoding.unsupported' === error.type ? createError(415, 'unsupported charset "' + encoding.toUpperCase() + '"', {
                        charset: encoding.toLowerCase(),
                        type: 'charset.unsupported'
                    }) : createError(400, error), stream !== req && (req.unpipe(), stream.destroy()), req1 = req, callback = function() {
                ...
                var str = body;
                try {
                    debug('parse body'), str = 'string' != typeof body && null !== encoding ? iconv.decode(body, encoding) : body, req.body = parse(str, encoding);
                } catch (err) {
    ...
    "../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/types/json.js" (module, __unused_rspack_exports, __webpack_require__) {
        var debug = __webpack_require__("../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/index.js")('body-parser:json'), read = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/read.js"), { normalizeOptions } = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/utils.js");
        module.exports = function(options) {
            let normalizedOptions = normalizeOptions(options, 'application/json');
            var reviver = options?.reviver, strict = options?.strict !== !1;
            function parse(body) {
                ...
                if (strict) {
                    ...
                    if ('{' !== first && '[' !== first) throw debug('strict violation'), function(str, char) {
                        ...
                        -1 !== index && (partial = str.substring(0, index) + '#'.repeat(str.length - index));
                        try {
    ...
    "../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/types/raw.js" (module, __unused_rspack_exports, __webpack_require__) {
        var debug = __webpack_require__("../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/index.js")('body-parser:raw'), read = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/read.js"), { normalizeOptions, passthrough } = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/utils.js");
        module.exports = function(options) {
            let readOptions = {
    ...
    "../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/types/text.js" (module, __unused_rspack_exports, __webpack_require__) {
        var debug = __webpack_require__("../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/index.js")('body-parser:text'), read = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/read.js"), { normalizeOptions, passthrough } = __webpack_require__("../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/utils.js");
        module.exports = function(options) {
            let normalizedOptions = normalizeOptions(options, 'text/plain');
            return function(req, res, next) {
    ...
    "../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/types/urlencoded.js" (module, __unused_rspack_exports, __webpack_require__) {
        ...
        module.exports = function(options) {
            ...
            var queryparse = function(options) {
                var extended = !!options?.extended, parameterLimit = options?.parameterLimit !== void 0 ? options?.parameterLimit : 1000, charsetSentinel = options?.charsetSentinel, interpretNumericEntities = options?.interpretNumericEntities, depth = extended ? options?.depth !== void 0 ? options?.depth : 32 : 0;
                ...
                return isFinite(parameterLimit) && (parameterLimit |= 0), function(body, encoding) {
                    var paramCount = function(body, limit) {
                        let count = 0, index = -1;
                        do {
    ...
    "../../node_modules/.pnpm/body-parser@2.2.2/node_modules/body-parser/lib/utils.js" (module, __unused_rspack_exports, __webpack_require__) {
        var bytes = __webpack_require__("../../node_modules/.pnpm/bytes@3.1.2/node_modules/bytes/index.js"), contentType = __webpack_require__("../../node_modules/.pnpm/content-type@1.0.5/node_modules/content-type/index.js"), typeis = __webpack_require__("../../node_modules/.pnpm/type-is@2.0.1/node_modules/type-is/index.js");
        module.exports = {
            getCharset: function(req) {
                try {
            ...
            normalizeOptions: function(options, defaultType) {
                if (!defaultType) throw TypeError('defaultType must be provided');
                var inflate = options?.inflate !== !1, limit = 'number' != typeof options?.limit ? bytes.parse(options?.limit || '100kb') : options?.limit, type = options?.type || defaultType, verify = options?.verify || !1, defaultCharset = options?.defaultCharset || 'utf-8';
                ...
                return {
                    ...
                    verify,
                    defaultCharset,
                    shouldParse: 'function' != typeof type ? function(req) {
    ...
    "../../node_modules/.pnpm/bytes@3.1.2/node_modules/bytes/index.js" (module) {
        ...
        function format(value, options) {
            ...
            return fixedDecimals || (str = str.replace(formatDecimalsRegExp, '$1')), thousandsSeparator && (str = str.split('.').map(function(s, i) {
                return 0 === i ? s.replace(formatThousandsRegExp, thousandsSeparator) : s;
            }).join('.')), str + unitSeparator + unit;
        }
        function parse(val) {
            ...
            return (results ? (floatValue = parseFloat(results[1]), unit = results[4].toLowerCase()) : (floatValue = parseInt(val, 10), unit = 'b'), isNaN(floatValue)) ? null : Math.floor(map[unit] * floatValue);
        }
    },
    ...
    "../../node_modules/.pnpm/call-bound@1.0.4/node_modules/call-bound/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var GetIntrinsic = __webpack_require__("../../node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js"), callBindBasic = __webpack_require__("../../node_modules/.pnpm/call-bind-apply-helpers@1.0.2/node_modules/call-bind-apply-helpers/index.js"), $indexOf = callBindBasic([
            GetIntrinsic('%String.prototype.indexOf%')
        ]);
        module.exports = function(name, allowMissing) {
            var intrinsic = GetIntrinsic(name, !!allowMissing);
            return 'function' == typeof intrinsic && $indexOf(name, '.prototype.') > -1 ? callBindBasic([
                intrinsic
            ]) : intrinsic;
        };
    },
    "../../node_modules/.pnpm/content-type@1.0.5/node_modules/content-type/index.js" (__unused_rspack_module, exports) {
        ...
        exports.format = function(obj) {
            ...
            if (-1 !== index) {
                for(PARAM_REGEXP.lastIndex = index; match = PARAM_REGEXP.exec(header);){
                    ...
                    index += match[0].length, key = match[1].toLowerCase(), 0x22 === (value = match[2]).charCodeAt(0) && -1 !== (value = value.slice(1, -1)).indexOf('\\') && (value = value.replace(QESC_REGEXP, '$1')), obj.parameters[key] = value;
                }
    ...
    "../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/node.js" (module, exports, __webpack_require__) {
        let tty = __webpack_require__("tty"), util = __webpack_require__("util?f585");
        ...
        try {
            let supportsColor = __webpack_require__("../../node_modules/.pnpm/supports-color@7.2.0/node_modules/supports-color/index.js");
    ...
    "../../node_modules/.pnpm/depd@2.0.0/node_modules/depd/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var relative = __webpack_require__("path?aeb1").relative;
        ...
        function defaultMessage(site) {
            ...
            return 'Object' === typeName && (typeName = void 0), 'Function' === typeName && (typeName = context.name || typeName), typeName && callSite.getMethodName() ? typeName + '.' + funcName : funcName;
        }
        ...
        function getStack() {
            ...
            Error.prepareStackTrace = prepareObjectStackTrace, Error.stackTraceLimit = Math.max(10, limit), Error.captureStackTrace(obj);
    ...
    "../../node_modules/.pnpm/http-errors@2.0.1/node_modules/http-errors/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var HttpError, exports, codes, HttpError1, deprecate = __webpack_require__("../../node_modules/.pnpm/depd@2.0.0/node_modules/depd/index.js")('http-errors'), setPrototypeOf = __webpack_require__("../../node_modules/.pnpm/setprototypeof@1.2.0/node_modules/setprototypeof/index.js"), statuses = __webpack_require__("../../node_modules/.pnpm/statuses@2.0.2/node_modules/statuses/index.js"), inherits = __webpack_require__("../../node_modules/.pnpm/inherits@2.0.4/node_modules/inherits/inherits.js"), toIdentifier = __webpack_require__("../../node_modules/.pnpm/toidentifier@1.0.1/node_modules/toidentifier/index.js");
        ...
        module.exports = function createError() {
            for(var err, msg, status = 500, props = {}, i = 0; i < arguments.length; i++){
                ...
                else throw TypeError('argument #' + (i + 1) + ' unsupported type ' + type);
            }
            'number' == typeof status && (status < 400 || status >= 600) && deprecate('non-error status code; use only 4xx or 5xx status codes'), ('number' != typeof status || !statuses.message[status] && (status < 400 || status >= 600)) && (status = 500);
        ...
        }), exports = module.exports, codes = statuses.codes, HttpError1 = module.exports.HttpError, codes.forEach(function(code) {
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/dbcs-codec.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        function DBCSCodec(codecOptions, iconv) {
            ...
            if ("function" == typeof codecOptions.gb18030) {
                ...
                this.decodeTables.push(UNASSIGNED_NODE.slice(0));
                for(var firstByteNode = this.decodeTables[0], i = 0x81; i <= 0xFE; i++)for(var secondByteNode = this.decodeTables[-1000 - firstByteNode[i]], j = 0x30; j <= 0x39; j++){
                    if (-1 === secondByteNode[j]) secondByteNode[j] = -1000 - commonThirdByteNodeIdx;
                    else if (secondByteNode[j] > -1000) throw Error("gb18030 decode tables conflict at byte 2");
                    for(var thirdByteNode = this.decodeTables[-1000 - secondByteNode[j]], k = 0x81; k <= 0xFE; k++){
                        if (-1 === thirdByteNode[k]) thirdByteNode[k] = -1000 - commonFourthByteNodeIdx;
                        else if (thirdByteNode[k] === -1000 - commonFourthByteNodeIdx) continue;
                        else if (thirdByteNode[k] > -1000) throw Error("gb18030 decode tables conflict at byte 3");
                        for(var fourthByteNode = this.decodeTables[-1000 - thirdByteNode[k]], l = 0x30; l <= 0x39; l++)-1 === fourthByteNode[l] && (fourthByteNode[l] = -2);
                    }
                }
            }
            ...
            if (codecOptions.encodeSkipVals) for(var i = 0; i < codecOptions.encodeSkipVals.length; i++){
                ...
                if ("number" == typeof val) skipEncodeChars[val] = !0;
            ...
            this.defCharSB = this.encodeTable[0][iconv.defaultCharSingleByte.charCodeAt(0)], -1 === this.defCharSB && (this.defCharSB = this.encodeTable[0]["?"]), -1 === this.defCharSB && (this.defCharSB = 63);
        }
        ...
        function DBCSDecoder(options, codec) {
            this.nodeIdx = 0, this.prevBytes = [], this.decodeTables = codec.decodeTables, this.decodeTableSeq = codec.decodeTableSeq, this.defaultCharUnicode = codec.defaultCharUnicode, this.gb18030 = codec.gb18030;
        }
        ...
        DBCSCodec.prototype.encoder = DBCSEncoder, DBCSCodec.prototype.decoder = DBCSDecoder, DBCSCodec.prototype._getDecodeTrieNode = function(addr) {
            for(var bytes = []; addr > 0; addr >>>= 8)bytes.push(0xFF & addr);
            ...
            for(var k = 1; k < chunk.length; k++){
                ...
                else throw Error("Incorrect type '" + typeof part + "' given in " + this.encodingName + " at chunk " + chunk[0]);
            }
            if (curAddr > 0xFF) throw Error("Incorrect chunk in " + this.encodingName + " at addr " + chunk[0] + ": too long" + curAddr);
            ...
            for(var node = this.decodeTables[nodeIdx], hasValues = !1, subNodeEmpty = {}, i = 0; i < 0x100; i++){
                var uCode = node[i], mbCode = prefix + i;
                if (!skipEncodeChars[mbCode]) if (uCode >= 0) this._setEncodeChar(uCode, mbCode), hasValues = !0;
                else if (uCode <= -1000) {
                    var subNodeIdx = -1000 - uCode;
                    if (!subNodeEmpty[subNodeIdx]) {
                        var newPrefix = mbCode << 8 >>> 0;
                        this._fillEncodeTable(subNodeIdx, newPrefix, skipEncodeChars) ? hasValues = !0 : subNodeEmpty[subNodeIdx] = !0;
                    }
                } else uCode <= -10 && (this._setEncodeSequence(this.decodeTableSeq[-10 - uCode], mbCode), hasValues = !0);
            }
            return hasValues;
                ...
                if (void 0 !== seqObj && -1 != uCode) {
                    ...
                    if (-1 == dbcsCode && this.gb18030) {
                        ...
                        if (-1 != idx) {
                            ...
                            newBuf[j++] = 0x81 + Math.floor(dbcsCode / 12600), dbcsCode %= 12600, newBuf[j++] = 0x30 + Math.floor(dbcsCode / 1260), dbcsCode %= 1260, newBuf[j++] = 0x81 + Math.floor(dbcsCode / 10), dbcsCode %= 10, newBuf[j++] = 0x30 + dbcsCode;
                            continue;
                        }
                    }
                }
                -1 === dbcsCode && (dbcsCode = this.defaultCharSingleByte), dbcsCode < 0x100 ? newBuf[j++] = dbcsCode : (dbcsCode < 0x10000 ? newBuf[j++] = dbcsCode >> 8 : dbcsCode < 0x1000000 ? (newBuf[j++] = dbcsCode >> 16, newBuf[j++] = dbcsCode >> 8 & 0xFF) : (newBuf[j++] = dbcsCode >>> 24, newBuf[j++] = dbcsCode >>> 16 & 0xFF, newBuf[j++] = dbcsCode >>> 8 & 0xFF), newBuf[j++] = 0xFF & dbcsCode);
            }
            ...
            for(var uCode, newBuf = Buffer1.alloc(2 * buf.length), nodeIdx = this.nodeIdx, prevBytes = this.prevBytes, prevOffset = this.prevBytes.length, seqStart = -this.prevBytes.length, i = 0, j = 0; i < buf.length; i++){
                var curByte = i >= 0 ? buf[i] : prevBytes[i + prevOffset], uCode = this.decodeTables[nodeIdx][curByte];
                if (uCode >= 0) ;
                else if (-1 === uCode) uCode = this.defaultCharUnicode.charCodeAt(0), i = seqStart;
                else if (-2 === uCode) {
                ...
                if (uCode >= 0x10000) {
                    var uCodeLead = 0xD800 | (uCode -= 0x10000) >> 10;
                    newBuf[j++] = 0xFF & uCodeLead, newBuf[j++] = uCodeLead >> 8, uCode = 0xDC00 | 0x3FF & uCode;
                }
                newBuf[j++] = 0xFF & uCode, newBuf[j++] = uCode >> 8, nodeIdx = 0, seqStart = i + 1;
            }
            return this.nodeIdx = nodeIdx, this.prevBytes = seqStart >= 0 ? Array.prototype.slice.call(buf, seqStart) : prevBytes.slice(seqStart + prevOffset).concat(Array.prototype.slice.call(buf)), newBuf.slice(0, j).toString("ucs2");
        }, DBCSDecoder.prototype.end = function() {
            for(var ret = ""; this.prevBytes.length > 0;){
                ret += this.defaultCharUnicode;
                var bytesArr = this.prevBytes.slice(1);
                this.prevBytes = [], this.nodeIdx = 0, bytesArr.length > 0 && (ret += this.write(bytesArr));
            }
            return this.prevBytes = [], this.nodeIdx = 0, ret;
        };
    },
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/index.js" (__unused_rspack___webpack_module__, exports, __webpack_require__) {
        ...
        ], i = 0; i < modules.length; i++)mergeModules(exports, modules[i]);
    },
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/internal.js" (module, __unused_rspack_exports, __webpack_require__) {
        ...
        function InternalCodec(codecOptions, iconv) {
            this.enc = codecOptions.encodingName, this.bomAware = codecOptions.bomAware, "base64" === this.enc ? this.encoder = InternalEncoderBase64 : "utf8" === this.enc ? this.encoder = InternalEncoderUtf8 : "cesu8" === this.enc && (this.enc = "utf8", this.encoder = InternalEncoderCesu8, "💩" !== Buffer1.from("eda0bdedb2a9", "hex").toString() && (this.decoder = InternalDecoderCesu8, this.defaultCharUnicode = iconv.defaultCharUnicode));
        }
        module.exports = {
            utf8: {
                type: "_internal",
        ...
        InternalDecoder.prototype.write = function(buf) {
            return Buffer1.isBuffer(buf) || (buf = Buffer1.from(buf)), this.decoder.write(buf);
            ...
            return this.prevStr = str.slice(completeQuads), str = str.slice(0, completeQuads), Buffer1.from(str, "base64");
        }, InternalEncoderBase64.prototype.end = function() {
            return Buffer1.from(this.prevStr, "base64");
        }, InternalEncoderCesu8.prototype.write = function(str) {
            for(var buf = Buffer1.alloc(3 * str.length), bufIdx = 0, i = 0; i < str.length; i++){
                var charCode = str.charCodeAt(i);
                charCode < 0x80 ? buf[bufIdx++] = charCode : (charCode < 0x800 ? buf[bufIdx++] = 0xC0 + (charCode >>> 6) : (buf[bufIdx++] = 0xE0 + (charCode >>> 12), buf[bufIdx++] = 0x80 + (charCode >>> 6 & 0x3f)), buf[bufIdx++] = 0x80 + (0x3f & charCode));
            }
            ...
            for(var acc = this.acc, contBytes = this.contBytes, accBytes = this.accBytes, res = "", i = 0; i < buf.length; i++){
                var curByte = buf[i];
                (0xC0 & curByte) != 0x80 ? (contBytes > 0 && (res += this.defaultCharUnicode, contBytes = 0), curByte < 0x80 ? res += String.fromCharCode(curByte) : curByte < 0xE0 ? (acc = 0x1F & curByte, contBytes = 1, accBytes = 1) : curByte < 0xF0 ? (acc = 0x0F & curByte, contBytes = 2, accBytes = 1) : res += this.defaultCharUnicode) : contBytes > 0 ? (acc = acc << 6 | 0x3f & curByte, contBytes--, accBytes++, 0 === contBytes && (2 === accBytes && acc < 0x80 && acc > 0 || 3 === accBytes && acc < 0x800 ? res += this.defaultCharUnicode : res += String.fromCharCode(acc))) : res += this.defaultCharUnicode;
            }
            ...
            if (this.highSurrogate && (str = this.highSurrogate + str, this.highSurrogate = ""), str.length > 0) {
                var charCode = str.charCodeAt(str.length - 1);
                charCode >= 0xd800 && charCode < 0xdc00 && (this.highSurrogate = str[str.length - 1], str = str.slice(0, str.length - 1));
            }
            return Buffer1.from(str, this.enc);
        }, InternalEncoderUtf8.prototype.end = function() {
            if (this.highSurrogate) {
                var str = this.highSurrogate;
                return this.highSurrogate = "", Buffer1.from(str, this.enc);
            }
        };
    },
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/sbcs-codec.js" (__unused_rspack_module, exports, __webpack_require__) {
        var Buffer1 = __webpack_require__("safer-buffer").Buffer;
        function SBCSCodec(codecOptions, iconv) {
            if (!codecOptions) throw Error("SBCS codec is called without the data.");
            if (!codecOptions.chars || 128 !== codecOptions.chars.length && 256 !== codecOptions.chars.length) throw Error("Encoding '" + codecOptions.type + "' has incorrect 'chars' (must be of len 128 or 256)");
            ...
            for(var encodeBuf = Buffer1.alloc(65536, iconv.defaultCharSingleByte.charCodeAt(0)), i = 0; i < codecOptions.chars.length; i++)encodeBuf[codecOptions.chars.charCodeAt(i)] = i;
        ...
        exports._sbcs = SBCSCodec, SBCSCodec.prototype.encoder = SBCSEncoder, SBCSCodec.prototype.decoder = SBCSDecoder, SBCSEncoder.prototype.write = function(str) {
            for(var buf = Buffer1.alloc(str.length), i = 0; i < str.length; i++)buf[i] = this.encodeBuf[str.charCodeAt(i)];
            return buf;
        }, SBCSEncoder.prototype.end = function() {}, SBCSDecoder.prototype.write = function(buf) {
            for(var decodeBuf = this.decodeBuf, newBuf = Buffer1.alloc(2 * buf.length), idx1 = 0, idx2 = 0, i = 0; i < buf.length; i++)idx1 = 2 * buf[i], newBuf[idx2 = 2 * i] = decodeBuf[idx1], newBuf[idx2 + 1] = decodeBuf[idx1 + 1];
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/utf16.js" (__unused_rspack_module, exports, __webpack_require__) {
        var Buffer1 = __webpack_require__("safer-buffer").Buffer;
        ...
        function Utf16Decoder(options, codec) {
            this.decoder = null, this.initialBufs = [], this.initialBufsLen = 0, this.options = options || {}, this.iconv = codec.iconv;
        }
        function detectEncoding(bufs, defaultEncoding) {
            var b = [], charsProcessed = 0, asciiCharsLE = 0, asciiCharsBE = 0;
            outerLoop: for(var i = 0; i < bufs.length; i++)for(var buf = bufs[i], j = 0; j < buf.length; j++)if (b.push(buf[j]), 2 === b.length) {
                if (0 === charsProcessed) {
                    if (0xFF === b[0] && 0xFE === b[1]) return "utf-16le";
                    if (0xFE === b[0] && 0xFF === b[1]) return "utf-16be";
                }
                if (0 === b[0] && 0 !== b[1] && asciiCharsBE++, 0 !== b[0] && 0 === b[1] && asciiCharsLE++, b.length = 0, ++charsProcessed >= 100) break outerLoop;
            }
            return asciiCharsBE > asciiCharsLE ? "utf-16be" : asciiCharsBE < asciiCharsLE ? "utf-16le" : defaultEncoding || "utf-16le";
        }
        exports.utf16be = Utf16BECodec, Utf16BECodec.prototype.encoder = Utf16BEEncoder, Utf16BECodec.prototype.decoder = Utf16BEDecoder, Utf16BECodec.prototype.bomAware = !0, Utf16BEEncoder.prototype.write = function(str) {
            for(var buf = Buffer1.from(str, "ucs2"), i = 0; i < buf.length; i += 2){
                var tmp = buf[i];
            ...
            for(-1 !== this.overflowByte && (buf2[0] = buf[0], buf2[1] = this.overflowByte, i = 1, j = 2); i < buf.length - 1; i += 2, j += 2)buf2[j] = buf[i + 1], buf2[j + 1] = buf[i];
            return this.overflowByte = i == buf.length - 1 ? buf[buf.length - 1] : -1, buf2.slice(0, j).toString("ucs2");
        }, Utf16BEDecoder.prototype.end = function() {
            this.overflowByte = -1;
        }, exports.utf16 = Utf16Codec, Utf16Codec.prototype.encoder = Utf16Encoder, Utf16Codec.prototype.decoder = Utf16Decoder, Utf16Encoder.prototype.write = function(str) {
            return this.encoder.write(str);
        }, Utf16Encoder.prototype.end = function() {
            return this.encoder.end();
        }, Utf16Decoder.prototype.write = function(buf) {
            if (!this.decoder) {
                if (this.initialBufs.push(buf), this.initialBufsLen += buf.length, this.initialBufsLen < 16) return "";
                var encoding = detectEncoding(this.initialBufs, this.options.defaultEncoding);
                this.decoder = this.iconv.getDecoder(encoding, this.options);
                for(var resStr = "", i = 0; i < this.initialBufs.length; i++)resStr += this.decoder.write(this.initialBufs[i]);
                return this.initialBufs.length = this.initialBufsLen = 0, resStr;
            }
            ...
            if (!this.decoder) {
                ...
                return trail && (resStr += trail), this.initialBufs.length = this.initialBufsLen = 0, resStr;
            }
            return this.decoder.end();
        };
    },
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/utf32.js" (__unused_rspack_module, exports, __webpack_require__) {
        var Buffer1 = __webpack_require__("safer-buffer").Buffer;
        function Utf32Codec(codecOptions, iconv) {
            this.iconv = iconv, this.bomAware = !0, this.isLE = codecOptions.isLE;
        }
        function Utf32Encoder(options, codec) {
            this.isLE = codec.isLE, this.highSurrogate = 0;
        }
        function Utf32Decoder(options, codec) {
            this.isLE = codec.isLE, this.badChar = codec.iconv.defaultCharUnicode.charCodeAt(0), this.overflow = [];
        }
        function _writeCodepoint(dst, offset, codepoint, badChar) {
            if ((codepoint < 0 || codepoint > 0x10FFFF) && (codepoint = badChar), codepoint >= 0x10000) {
                var high = 0xD800 | (codepoint -= 0x10000) >> 10;
                dst[offset++] = 0xff & high, dst[offset++] = high >> 8;
                var codepoint = 0xDC00 | 0x3FF & codepoint;
            }
            return dst[offset++] = 0xff & codepoint, dst[offset++] = codepoint >> 8, offset;
        }
        function Utf32AutoCodec(options, iconv) {
            this.iconv = iconv;
        }
        function Utf32AutoEncoder(options, codec) {
            void 0 === (options = options || {}).addBOM && (options.addBOM = !0), this.encoder = codec.iconv.getEncoder(options.defaultEncoding || "utf-32le", options);
        }
        function Utf32AutoDecoder(options, codec) {
            this.decoder = null, this.initialBufs = [], this.initialBufsLen = 0, this.options = options || {}, this.iconv = codec.iconv;
        }
        function detectEncoding(bufs, defaultEncoding) {
            var b = [], charsProcessed = 0, invalidLE = 0, invalidBE = 0, bmpCharsLE = 0, bmpCharsBE = 0;
            outerLoop: for(var i = 0; i < bufs.length; i++)for(var buf = bufs[i], j = 0; j < buf.length; j++)if (b.push(buf[j]), 4 === b.length) {
                if (0 === charsProcessed) {
                    if (0xFF === b[0] && 0xFE === b[1] && 0 === b[2] && 0 === b[3]) return "utf-32le";
                    if (0 === b[0] && 0 === b[1] && 0xFE === b[2] && 0xFF === b[3]) return "utf-32be";
                }
                if ((0 !== b[0] || b[1] > 0x10) && invalidBE++, (0 !== b[3] || b[2] > 0x10) && invalidLE++, 0 === b[0] && 0 === b[1] && (0 !== b[2] || 0 !== b[3]) && bmpCharsBE++, (0 !== b[0] || 0 !== b[1]) && 0 === b[2] && 0 === b[3] && bmpCharsLE++, b.length = 0, ++charsProcessed >= 100) break outerLoop;
            }
            return bmpCharsBE - invalidBE > bmpCharsLE - invalidLE ? "utf-32be" : bmpCharsBE - invalidBE < bmpCharsLE - invalidLE ? "utf-32le" : defaultEncoding || "utf-32le";
        }
        exports._utf32 = Utf32Codec, exports.utf32le = {
            type: "_utf32",
            isLE: !0
        }, exports.utf32be = {
            type: "_utf32",
            isLE: !1
        }, exports.ucs4le = "utf32le", exports.ucs4be = "utf32be", Utf32Codec.prototype.encoder = Utf32Encoder, Utf32Codec.prototype.decoder = Utf32Decoder, Utf32Encoder.prototype.write = function(str) {
            for(var src = Buffer1.from(str, "ucs2"), dst = Buffer1.alloc(2 * src.length), write32 = this.isLE ? dst.writeUInt32LE : dst.writeUInt32BE, offset = 0, i = 0; i < src.length; i += 2){
                var code = src.readUInt16LE(i), isHighSurrogate = code >= 0xD800 && code < 0xDC00, isLowSurrogate = code >= 0xDC00 && code < 0xE000;
                if (this.highSurrogate) if (isHighSurrogate || !isLowSurrogate) write32.call(dst, this.highSurrogate, offset), offset += 4;
                else {
                    var codepoint = (this.highSurrogate - 0xD800 << 10 | code - 0xDC00) + 0x10000;
                    write32.call(dst, codepoint, offset), offset += 4, this.highSurrogate = 0;
                    continue;
                }
                isHighSurrogate ? this.highSurrogate = code : (write32.call(dst, code, offset), offset += 4, this.highSurrogate = 0);
            }
            return offset < dst.length && (dst = dst.slice(0, offset)), dst;
        }, Utf32Encoder.prototype.end = function() {
            if (this.highSurrogate) {
                var buf = Buffer1.alloc(4);
                return this.isLE ? buf.writeUInt32LE(this.highSurrogate, 0) : buf.writeUInt32BE(this.highSurrogate, 0), this.highSurrogate = 0, buf;
            }
        }, Utf32Decoder.prototype.write = function(src) {
            if (0 === src.length) return "";
            var i = 0, codepoint = 0, dst = Buffer1.alloc(src.length + 4), offset = 0, isLE = this.isLE, overflow = this.overflow, badChar = this.badChar;
            if (overflow.length > 0) {
                for(; i < src.length && overflow.length < 4; i++)overflow.push(src[i]);
                4 === overflow.length && (codepoint = isLE ? overflow[i] | overflow[i + 1] << 8 | overflow[i + 2] << 16 | overflow[i + 3] << 24 : overflow[i + 3] | overflow[i + 2] << 8 | overflow[i + 1] << 16 | overflow[i] << 24, overflow.length = 0, offset = _writeCodepoint(dst, offset, codepoint, badChar));
            }
            for(; i < src.length - 3; i += 4)offset = _writeCodepoint(dst, offset, codepoint = isLE ? src[i] | src[i + 1] << 8 | src[i + 2] << 16 | src[i + 3] << 24 : src[i + 3] | src[i + 2] << 8 | src[i + 1] << 16 | src[i] << 24, badChar);
            for(; i < src.length; i++)overflow.push(src[i]);
            return dst.slice(0, offset).toString("ucs2");
        }, Utf32Decoder.prototype.end = function() {
            this.overflow.length = 0;
        }, exports.utf32 = Utf32AutoCodec, exports.ucs4 = "utf32", Utf32AutoCodec.prototype.encoder = Utf32AutoEncoder, Utf32AutoCodec.prototype.decoder = Utf32AutoDecoder, Utf32AutoEncoder.prototype.write = function(str) {
            return this.encoder.write(str);
        }, Utf32AutoEncoder.prototype.end = function() {
            return this.encoder.end();
        }, Utf32AutoDecoder.prototype.write = function(buf) {
            if (!this.decoder) {
                if (this.initialBufs.push(buf), this.initialBufsLen += buf.length, this.initialBufsLen < 32) return "";
                var encoding = detectEncoding(this.initialBufs, this.options.defaultEncoding);
                this.decoder = this.iconv.getDecoder(encoding, this.options);
                for(var resStr = "", i = 0; i < this.initialBufs.length; i++)resStr += this.decoder.write(this.initialBufs[i]);
                return this.initialBufs.length = this.initialBufsLen = 0, resStr;
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/encodings/utf7.js" (__unused_rspack_module, exports, __webpack_require__) {
        var Buffer1 = __webpack_require__("safer-buffer").Buffer;
        function Utf7Codec(codecOptions, iconv) {
            this.iconv = iconv;
        }
        exports.utf7 = Utf7Codec, exports.unicode11utf7 = "utf7", Utf7Codec.prototype.encoder = Utf7Encoder, Utf7Codec.prototype.decoder = Utf7Decoder, Utf7Codec.prototype.bomAware = !0;
        ...
        function Utf7IMAPEncoder(options, codec) {
            this.iconv = codec.iconv, this.inBase64 = !1, this.base64Accum = Buffer1.alloc(6), this.base64AccumIdx = 0;
        }
        ...
        Utf7Decoder.prototype.write = function(buf) {
            ...
            if (inBase64) {
                var b64str = base64Accum + this.iconv.decode(buf.slice(lastI), "ascii"), canBeDecoded = b64str.length - b64str.length % 8;
            ...
            var res = "";
            return this.inBase64 && this.base64Accum.length > 0 && (res = this.iconv.decode(Buffer1.from(this.base64Accum, "base64"), "utf16-be")), this.inBase64 = !1, this.base64Accum = "", res;
        }, exports.utf7imap = Utf7IMAPCodec, Utf7IMAPCodec.prototype.encoder = Utf7IMAPEncoder, Utf7IMAPCodec.prototype.decoder = Utf7IMAPDecoder, Utf7IMAPCodec.prototype.bomAware = !0, Utf7IMAPEncoder.prototype.write = function(str) {
        ...
        base64IMAPChars[44] = !0, Utf7IMAPDecoder.prototype.write = function(buf) {
            ...
            if (inBase64) {
                var b64str = base64Accum + this.iconv.decode(buf.slice(lastI), "ascii").replace(/,/g, "/"), canBeDecoded = b64str.length - b64str.length % 8;
                base64Accum = b64str.slice(canBeDecoded), b64str = b64str.slice(0, canBeDecoded), res += this.iconv.decode(Buffer1.from(b64str, "base64"), "utf16-be");
            } else res += this.iconv.decode(buf.slice(lastI), "ascii");
            return this.inBase64 = inBase64, this.base64Accum = base64Accum, res;
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/bom-handling.js" (__unused_rspack_module, exports) {
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/helpers/merge-exports.js" (module) {
        ...
        module.exports = function(target, module) {
            for(var key in module)hasOwn(module, key) && (target[key] = module[key]);
        };
    },
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var streamModule, Buffer1 = __webpack_require__("safer-buffer").Buffer, bomHandling = __webpack_require__("../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/bom-handling.js"), mergeModules = __webpack_require__("../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/helpers/merge-exports.js"), iconv = module.exports;
        iconv.encodings = null, iconv.defaultCharUnicode = "�", iconv.defaultCharSingleByte = "?", iconv.encode = function(str, encoding, options) {
            str = "" + (str || "");
            ...
            "string" == typeof buf && (iconv.skipDecodeWarning || (console.error("Iconv-lite warning: decode()-ing strings is deprecated. Refer to https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding"), iconv.skipDecodeWarning = !0), buf = Buffer1.from("" + (buf || ""), "binary"));
            ...
            return codec.bomAware && options && options.addBOM && (encoder = new bomHandling.PrependBOM(encoder, options)), encoder;
        }, iconv.getDecoder = function(encoding, options) {
            var codec = iconv.getCodec(encoding), decoder = new codec.decoder(options, codec);
            return codec.bomAware && !(options && !1 === options.stripBOM) && (decoder = new bomHandling.StripBOM(decoder, options)), decoder;
            ...
            if (!iconv.supportsStreams) {
                ...
                iconv.IconvLiteEncoderStream = streams.IconvLiteEncoderStream, iconv.IconvLiteDecoderStream = streams.IconvLiteDecoderStream, iconv.encodeStream = function(encoding, options) {
        ...
        try {
            streamModule = __webpack_require__("stream?1b1a");
        } catch (e) {}
        streamModule && streamModule.Transform ? iconv.enableStreamingAPI(streamModule) : iconv.encodeStream = iconv.decodeStream = function() {
    ...
    "../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/streams.js" (module, __unused_rspack_exports, __webpack_require__) {
        ...
        module.exports = function(streamModule) {
            ...
            return IconvLiteEncoderStream.prototype = Object.create(Transform.prototype, {
                constructor: {
                    value: IconvLiteEncoderStream
                }
            }), IconvLiteEncoderStream.prototype._transform = function(chunk, encoding, done) {
                if ("string" != typeof chunk) return done(Error("Iconv encoding stream needs strings as its input."));
                try {
                ...
                if (!Buffer1.isBuffer(chunk) && !(chunk instanceof Uint8Array)) return done(Error("Iconv decoding stream needs buffers as its input."));
                try {
                    var res = this.conv.write(chunk);
    ...
    "../../node_modules/.pnpm/inherits@2.0.4/node_modules/inherits/inherits.js" (module, __unused_rspack_exports, __webpack_require__) {
        try {
            var util = __webpack_require__("util?f585");
    ...
    "../../node_modules/.pnpm/media-typer@1.1.0/node_modules/media-typer/index.js" (__unused_rspack_module, exports) {
        ...
        exports.format = function(obj) {
            ...
            if (!type || !TYPE_NAME_REGEXP.test(type)) throw TypeError('invalid type');
            if (!subtype || !SUBTYPE_NAME_REGEXP.test(subtype)) throw TypeError('invalid subtype');
            var string = type + '/' + subtype;
            if (suffix) {
                if (!TYPE_NAME_REGEXP.test(suffix)) throw TypeError('invalid suffix');
                string += '+' + suffix;
            }
            return string;
        }, exports.parse = function(string) {
            if (!string) throw TypeError('argument string is required');
            if ('string' != typeof string) throw TypeError('argument string is required to be a string');
            var suffix, match = TYPE_REGEXP.exec(string.toLowerCase());
            if (!match) throw TypeError('invalid media type');
            var type = match[1], subtype = match[2], index = subtype.lastIndexOf('+');
            return -1 !== index && (suffix = subtype.substr(index + 1), subtype = subtype.substr(0, index)), new MediaType(type, subtype, suffix);
    ...
    "../../node_modules/.pnpm/mime-types@3.0.1/node_modules/mime-types/index.js" (__unused_rspack_module, exports, __webpack_require__) {
        var extensions, types, db = __webpack_require__("../../node_modules/.pnpm/mime-db@1.54.0/node_modules/mime-db/index.js"), extname = __webpack_require__("path?aeb1").extname, mimeScore = __webpack_require__("../../node_modules/.pnpm/mime-types@3.0.1/node_modules/mime-types/mimeScore.js"), EXTRACT_TYPE_REGEXP = /^\s*([^;\s]*)(?:;|\s|$)/, TEXT_TYPE_REGEXP = /^text\//i;
        ...
        exports.charset = charset, exports.charsets = {
            ...
            return mime;
        }, exports.extension = extension, exports.extensions = Object.create(null), exports.lookup = function(path) {
        ...
        }, exports.types = Object.create(null), exports._extensionConflicts = [], extensions = exports.extensions, types = exports.types, Object.keys(db).forEach(function(type) {
            ...
            if (exts && exts.length) {
                ...
                for(var i = 0; i < exts.length; i++){
                    ...
                    let legacyType = function(type0, type1) {
                        ...
                        return 'application/octet-stream' !== exports.types[extension] && (score0 > score1 || score0 === score1 && exports.types[extension]?.slice(0, 12) === 'application/') || score0 > score1 ? type0 : type1;
                    }(types[extension1], type);
                    legacyType !== types[extension1] && exports._extensionConflicts.push([
                        extension1,
                        legacyType,
                        types[extension1]
                    ]);
    ...
    "../../node_modules/.pnpm/mime-types@3.0.1/node_modules/mime-types/mimeScore.js" (module) {
        ...
        module.exports = function(mimeType, source = 'default') {
            ...
            return (FACET_SCORES[subtype.replace(/(\.|x-).*/, '$1')] || FACET_SCORES.default) + (SOURCE_SCORES[source] || SOURCE_SCORES.default) + (TYPE_SCORES[type] || TYPE_SCORES.default) + (1 - mimeType.length / 100);
        };
    },
    ...
    "../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        ...
        var utilInspect = __webpack_require__("../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/util.inspect.js"), inspectCustom = utilInspect.custom, inspectSymbol = isSymbol(inspectCustom) ? inspectCustom : null, quotes = {
            __proto__: null,
            double: '"',
            single: "'"
        }, quoteREs = {
        ...
        module.exports = function inspect_(obj, options, depth, seen) {
            ...
            if ('boolean' != typeof customInspect && 'symbol' !== customInspect) throw TypeError('option "customInspect", if provided, must be `true`, `false`, or `\'symbol\'`');
            if (has(opts, 'indent') && null !== opts.indent && '\t' !== opts.indent && !(parseInt(opts.indent, 10) === opts.indent && opts.indent > 0)) throw TypeError('option "indent" must be "\\t", an integer > 0, or `null`');
            if (has(opts, 'numericSeparator') && 'boolean' != typeof opts.numericSeparator) throw TypeError('option "numericSeparator", if provided, must be `true` or `false`');
            ...
            if ((x = obj) && 'object' == typeof x && ("u" > typeof HTMLElement && x instanceof HTMLElement || 'string' == typeof x.nodeName && 'function' == typeof x.getAttribute)) {
        ...
        function arrObjKeys(obj, inspect) {
            var symMap, isArr = isArray(obj), xs = [];
            if (isArr) {
            ...
            for(var key in obj)if (has(obj, key) && (!isArr || String(Number(key)) !== key || !(key < obj.length))) if (hasShammedSymbols && symMap['$' + key] instanceof Symbol) continue;
            else $test.call(/[^\w$]/, key) ? xs.push(inspect(key, obj) + ': ' + inspect(obj[key], obj)) : xs.push(key + ': ' + inspect(obj[key], obj));
    ...
    "../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/util.inspect.js" (module, __unused_rspack_exports, __webpack_require__) {
        module.exports = __webpack_require__("util?ace4").inspect;
    },
    ...
    "../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/formats.js" (module) {
    ...
    "../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var stringify = __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/stringify.js"), parse = __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/parse.js");
        module.exports = {
            formats: __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/formats.js"),
            parse: parse,
            stringify: stringify
        };
    },
    "../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/parse.js" (module, __unused_rspack_exports, __webpack_require__) {
        var utils = __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/utils.js"), has = Object.prototype.hasOwnProperty, isArray = Array.isArray, defaults = {
            allowDots: !1,
            allowEmptyArrays: !1,
            allowPrototypes: !1,
            allowSparse: !1,
            ...
            if (options.throwOnLimitExceeded && currentArrayLength >= options.arrayLimit) throw RangeError('Array limit exceeded. Only ' + options.arrayLimit + ' element' + (1 === options.arrayLimit ? '' : 's') + ' allowed in an array.');
            return val;
            ...
            var limit = options.parameterLimit === 1 / 0 ? void 0 : options.parameterLimit, parts = cleanStr.split(options.delimiter, options.throwOnLimitExceeded && void 0 !== limit ? limit + 1 : limit);
            if (options.throwOnLimitExceeded && void 0 !== limit && parts.length > limit) throw RangeError('Parameter limit exceeded. Only ' + limit + ' parameter' + (1 === limit ? '' : 's') + ' allowed.');
            var skipIndex = -1, charset = options.charset;
            ...
            for(i = 0; i < parts.length; ++i)if (i !== skipIndex) {
                ...
                if (-1 === pos ? (key = options.decoder(part, defaults.decoder, charset, 'key'), val = options.strictNullHandling ? null : '') : null !== (key = options.decoder(part.slice(0, pos), defaults.decoder, charset, 'key')) && (val = utils.maybeMap(parseArrayValue(part.slice(pos + 1), options, isArray(obj[key]) ? obj[key].length : 0), function(encodedVal) {
                    return options.decoder(encodedVal, defaults.decoder, charset, 'value');
                })), val && options.interpretNumericEntities && 'iso-8859-1' === charset && (val = String(val).replace(/&#(\d+);/g, function($0, numberStr) {
            ...
            return leaf;
        }, splitKeyIntoSegments = function(originalKey, options) {
            var key = options.allowDots ? originalKey.replace(/\.([^.[]+)/g, '[$1]') : originalKey;
            if (options.depth <= 0) {
                if (!options.plainObjects && has.call(Object.prototype, key) && !options.allowPrototypes) return;
                return [
                    key
                ];
            }
            var segments = [], first = key.indexOf('['), parent = first >= 0 ? key.slice(0, first) : key;
            if (parent) {
                if (!options.plainObjects && has.call(Object.prototype, parent) && !options.allowPrototypes) return;
                segments[segments.length] = parent;
            }
            for(var n = key.length, open = first, collected = 0; open >= 0 && collected < options.depth;){
                for(var level = 1, i = open + 1, close = -1; i < n && close < 0;){
                    var cu = key.charCodeAt(i);
                    0x5B === cu ? level += 1 : 0x5D === cu && 0 == (level -= 1) && (close = i), i += 1;
                }
                if (close < 0) return segments[segments.length] = '[' + key.slice(open) + ']', segments;
                var seg = key.slice(open, close + 1), content = seg.slice(1, -1);
                if (!options.plainObjects && has.call(Object.prototype, content) && !options.allowPrototypes) return;
                segments[segments.length] = seg, collected += 1, open = key.indexOf('[', close + 1);
            }
            if (open >= 0) {
            ...
            if (givenKey) {
                ...
                if (keys) return parseObject(keys, val, options, valuesParsed);
            }
        }, normalizeParseOptions = function(opts) {
            if (!opts) return defaults;
            if (void 0 !== opts.allowEmptyArrays && 'boolean' != typeof opts.allowEmptyArrays) throw TypeError('`allowEmptyArrays` option can only be `true` or `false`, when provided');
            if (void 0 !== opts.decodeDotInKeys && 'boolean' != typeof opts.decodeDotInKeys) throw TypeError('`decodeDotInKeys` option can only be `true` or `false`, when provided');
            if (null !== opts.decoder && void 0 !== opts.decoder && 'function' != typeof opts.decoder) throw TypeError('Decoder has to be a function.');
            if (void 0 !== opts.charset && 'utf-8' !== opts.charset && 'iso-8859-1' !== opts.charset) throw TypeError('The charset option must be either utf-8, iso-8859-1, or undefined');
            if (void 0 !== opts.throwOnLimitExceeded && 'boolean' != typeof opts.throwOnLimitExceeded) throw TypeError('`throwOnLimitExceeded` option must be a boolean');
            ...
            if ('combine' !== duplicates && 'first' !== duplicates && 'last' !== duplicates) throw TypeError('The duplicates option must be either combine, first, or last');
            return {
        ...
        module.exports = function(str, opts) {
            ...
            for(var tempObj = 'string' == typeof str ? parseValues(str, options) : str, obj = options.plainObjects ? {
                __proto__: null
    ...
    "../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/stringify.js" (module, __unused_rspack_exports, __webpack_require__) {
        var getSideChannel = __webpack_require__("../../node_modules/.pnpm/side-channel@1.1.0/node_modules/side-channel/index.js"), utils = __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/utils.js"), formats = __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/formats.js"), has = Object.prototype.hasOwnProperty, arrayPrefixGenerators = {
            ...
            if ('comma' === generateArrayPrefix && isArray(obj)) encodeValuesOnly && encoder && (obj = utils.maybeMap(obj, function(v) {
            ...
            var encodedPrefix = encodeDotInKeys ? String(prefix).replace(/\./g, '%2E') : String(prefix), adjustedPrefix = commaRoundTrip && isArray(obj) && 1 === obj.length ? encodedPrefix + '[]' : encodedPrefix;
            if (allowEmptyArrays && isArray(obj) && 0 === obj.length) return adjustedPrefix + '[]';
            for(var j = 0; j < objKeys.length; ++j){
                var key = objKeys[j], value = 'object' == typeof key && key && void 0 !== key.value ? key.value : obj[key];
                if (!skipNulls || null !== value) {
                    var encodedKey = allowDots && encodeDotInKeys ? String(key).replace(/\./g, '%2E') : String(key), keyPrefix = isArray(obj) ? 'function' == typeof generateArrayPrefix ? generateArrayPrefix(adjustedPrefix, encodedKey) : adjustedPrefix : adjustedPrefix + (allowDots ? '.' + encodedKey : '[' + encodedKey + ']');
            ...
            if (!opts) return defaults;
            if (void 0 !== opts.allowEmptyArrays && 'boolean' != typeof opts.allowEmptyArrays) throw TypeError('`allowEmptyArrays` option can only be `true` or `false`, when provided');
            if (void 0 !== opts.encodeDotInKeys && 'boolean' != typeof opts.encodeDotInKeys) throw TypeError('`encodeDotInKeys` option can only be `true` or `false`, when provided');
            if (null !== opts.encoder && void 0 !== opts.encoder && 'function' != typeof opts.encoder) throw TypeError('Encoder has to be a function.');
            var arrayFormat, charset = opts.charset || defaults.charset;
            if (void 0 !== opts.charset && 'utf-8' !== opts.charset && 'iso-8859-1' !== opts.charset) throw TypeError('The charset option must be either utf-8, iso-8859-1, or undefined');
            var format = formats.default;
            if (void 0 !== opts.format) {
                if (!has.call(formats.formatters, opts.format)) throw TypeError('Unknown format option provided.');
                format = opts.format;
            }
        ...
        module.exports = function(object, opts) {
            ...
            return options.charsetSentinel && ('iso-8859-1' === options.charset ? prefix += 'utf8=%26%2310003%3B' + options.delimiter : prefix += 'utf8=%E2%9C%93' + options.delimiter), joined.length > 0 ? prefix + joined : '';
        };
    },
    "../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/utils.js" (module, __unused_rspack_exports, __webpack_require__) {
        var formats = __webpack_require__("../../node_modules/.pnpm/qs@6.15.2/node_modules/qs/lib/formats.js"), getSideChannel = __webpack_require__("../../node_modules/.pnpm/side-channel@1.1.0/node_modules/side-channel/index.js"), has = Object.prototype.hasOwnProperty, isArray = Array.isArray, overflowChannel = getSideChannel(), markOverflow = function(obj, maxIndex) {
            return overflowChannel.set(obj, maxIndex), obj;
        }, isOverflow = function(obj) {
            return overflowChannel.has(obj);
        }, getMaxIndex = function(obj) {
        ...
        module.exports = {
            ...
            combine: function(a, b, arrayLimit, plainObjects) {
                if (isOverflow(a)) {
                    var newIndex = getMaxIndex(a) + 1;
                    return a[newIndex] = b, setMaxIndex(a, newIndex), a;
                }
                var result = [].concat(a, b);
                return result.length > arrayLimit ? markOverflow(arrayToObject(result, {
            ...
            encode: function(str, defaultEncoder, charset, kind, format) {
                ...
                for(var out = '', j = 0; j < string.length; j += 1024){
                    for(var segment = string.length >= 1024 ? string.slice(j, j + 1024) : string, arr = [], i = 0; i < segment.length; ++i){
                        ...
                        i += 1, c = 0x10000 + ((0x3FF & c) << 10 | 0x3FF & segment.charCodeAt(i)), arr[arr.length] = hexTable[0xF0 | c >> 18] + hexTable[0x80 | c >> 12 & 0x3F] + hexTable[0x80 | c >> 6 & 0x3F] + hexTable[0x80 | 0x3F & c];
                    }
                    out += arr.join('');
                }
                return out;
            ...
            merge: function merge(target, source, options) {
                ...
                if (!target || 'object' != typeof target) {
                    if (isOverflow(source)) {
                        for(var sourceKeys = Object.keys(source), result = options && options.plainObjects ? {
                            __proto__: null,
                            0: target
                        } : {
                            0: target
    ...
    "../../node_modules/.pnpm/raw-body@3.0.2/node_modules/raw-body/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var asyncHooks = function() {
            try {
                return __webpack_require__("async_hooks");
            } catch (e) {
        ...
        }(), bytes = __webpack_require__("../../node_modules/.pnpm/bytes@3.1.2/node_modules/bytes/index.js"), createError = __webpack_require__("../../node_modules/.pnpm/http-errors@2.0.1/node_modules/http-errors/index.js"), iconv = __webpack_require__("../../node_modules/.pnpm/iconv-lite@0.7.0/node_modules/iconv-lite/lib/index.js"), unpipe = __webpack_require__("../../node_modules/.pnpm/unpipe@1.0.0/node_modules/unpipe/index.js");
        ...
        function readStream(stream, encoding, length, limit, callback) {
            ...
            function cleanup() {
                buffer = null, stream.removeListener('aborted', onAborted), stream.removeListener('data', onData), stream.removeListener('end', onEnd), stream.removeListener('error', onEnd), stream.removeListener('close', cleanup);
            }
    ...
    "../../node_modules/.pnpm/side-channel-list@1.0.0/node_modules/side-channel-list/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var inspect = __webpack_require__("../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/index.js"), $TypeError = __webpack_require__("../../node_modules/.pnpm/es-errors@1.3.0/node_modules/es-errors/type.js"), listGetNode = function(list, key, isDelete) {
            for(var curr, prev = list; null != (curr = prev.next); prev = curr)if (curr.key === key) return prev.next = curr.next, isDelete || (curr.next = list.next, list.next = curr), curr;
        ...
        module.exports = function() {
            var $o, channel = {
                ...
                delete: function(key) {
                    var root = $o && $o.next, deletedNode = listDelete($o, key);
    ...
    "../../node_modules/.pnpm/side-channel-map@1.0.1/node_modules/side-channel-map/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var GetIntrinsic = __webpack_require__("../../node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js"), callBound = __webpack_require__("../../node_modules/.pnpm/call-bound@1.0.4/node_modules/call-bound/index.js"), inspect = __webpack_require__("../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/index.js"), $TypeError = __webpack_require__("../../node_modules/.pnpm/es-errors@1.3.0/node_modules/es-errors/type.js"), $Map = GetIntrinsic('%Map%', !0), $mapGet = callBound('Map.prototype.get', !0), $mapSet = callBound('Map.prototype.set', !0), $mapHas = callBound('Map.prototype.has', !0), $mapDelete = callBound('Map.prototype.delete', !0), $mapSize = callBound('Map.prototype.size', !0);
    ...
    "../../node_modules/.pnpm/side-channel-weakmap@1.0.2/node_modules/side-channel-weakmap/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var GetIntrinsic = __webpack_require__("../../node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js"), callBound = __webpack_require__("../../node_modules/.pnpm/call-bound@1.0.4/node_modules/call-bound/index.js"), inspect = __webpack_require__("../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/index.js"), getSideChannelMap = __webpack_require__("../../node_modules/.pnpm/side-channel-map@1.0.1/node_modules/side-channel-map/index.js"), $TypeError = __webpack_require__("../../node_modules/.pnpm/es-errors@1.3.0/node_modules/es-errors/type.js"), $WeakMap = GetIntrinsic('%WeakMap%', !0), $weakMapGet = callBound('WeakMap.prototype.get', !0), $weakMapSet = callBound('WeakMap.prototype.set', !0), $weakMapHas = callBound('WeakMap.prototype.has', !0), $weakMapDelete = callBound('WeakMap.prototype.delete', !0);
    ...
    "../../node_modules/.pnpm/side-channel@1.1.0/node_modules/side-channel/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var $TypeError = __webpack_require__("../../node_modules/.pnpm/es-errors@1.3.0/node_modules/es-errors/type.js"), inspect = __webpack_require__("../../node_modules/.pnpm/object-inspect@1.13.3/node_modules/object-inspect/index.js"), getSideChannelList = __webpack_require__("../../node_modules/.pnpm/side-channel-list@1.0.0/node_modules/side-channel-list/index.js"), getSideChannelMap = __webpack_require__("../../node_modules/.pnpm/side-channel-map@1.0.1/node_modules/side-channel-map/index.js"), makeChannel = __webpack_require__("../../node_modules/.pnpm/side-channel-weakmap@1.0.2/node_modules/side-channel-weakmap/index.js") || getSideChannelMap || getSideChannelList;
        module.exports = function() {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/array-set.js" (__unused_rspack_module, exports) {
        exports.C = class ArraySet {
            constructor(){
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/base64-vlq.js" (__unused_rspack_module, exports, __webpack_require__) {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/base64.js" (__unused_rspack_module, exports) {
        let intToCharMap = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");
        exports.encode = function(number) {
            if (0 <= number && number < intToCharMap.length) return intToCharMap[number];
            throw TypeError("Must be between 0 and 63: " + number);
        };
    },
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/mapping-list.js" (__unused_rspack_module, exports, __webpack_require__) {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/read-wasm.js" (module, __unused_rspack_exports, __webpack_require__) {
        var __dirname = __rspack_dirname(__rspack_fileURLToPath(import.meta.url));
        let fs = __webpack_require__("fs?8b28"), path = __webpack_require__("path?aeb1");
        module.exports = function() {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/source-map-consumer.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class SourceMapConsumer {
            constructor(aSourceMap, aSourceMapURL){
                ...
                return aSourceMap1 = aSourceMap, aSourceMapURL1 = aSourceMapURL, sourceMap = aSourceMap1, "string" == typeof aSourceMap1 && (sourceMap = util.parseSourceMapInput(aSourceMap1)), Promise.resolve(null != sourceMap.sections ? new IndexedSourceMapConsumer(sourceMap, aSourceMapURL1) : new BasicSourceMapConsumer(sourceMap, aSourceMapURL1));
            }
            ...
            eachMapping(aCallback, aContext, aOrder) {
                throw Error("Subclasses must implement eachMapping");
            }
            allGeneratedPositionsFor(aArgs) {
                throw Error("Subclasses must implement allGeneratedPositionsFor");
            }
            destroy() {
                throw Error("Subclasses must implement destroy");
            }
        }
        SourceMapConsumer.prototype._version = 3, SourceMapConsumer.GENERATED_ORDER = 1, SourceMapConsumer.ORIGINAL_ORDER = 2, SourceMapConsumer.GREATEST_LOWER_BOUND = 1, SourceMapConsumer.LEAST_UPPER_BOUND = 2, exports.YK = SourceMapConsumer;
        class BasicSourceMapConsumer extends SourceMapConsumer {
            constructor(aSourceMap, aSourceMapURL){
                return super(INTERNAL).then((that)=>{
                    let sourceMap = aSourceMap;
                    "string" == typeof aSourceMap && (sourceMap = util.parseSourceMapInput(aSourceMap));
                    let version = util.getArg(sourceMap, "version"), sources = util.getArg(sourceMap, "sources").map(String), names = util.getArg(sourceMap, "names", []), sourceRoot = util.getArg(sourceMap, "sourceRoot", null), sourcesContent = util.getArg(sourceMap, "sourcesContent", null), mappings = util.getArg(sourceMap, "mappings"), file = util.getArg(sourceMap, "file", null), x_google_ignoreList = util.getArg(sourceMap, "x_google_ignoreList", null);
                    if (version != that._version) throw Error("Unsupported version: " + version);
                    return that._sourceLookupCache = new Map(), that._names = ArraySet.fromArray(names.map(String), !0), that._sources = ArraySet.fromArray(sources, !0), that._absoluteSources = ArraySet.fromArray(that._sources.toArray().map(function(s) {
                        return util.computeSourceURL(sourceRoot, s, aSourceMapURL);
                    }), !0), that.sourceRoot = sourceRoot, that.sourcesContent = sourcesContent, that._mappings = mappings, that._sourceMapURL = aSourceMapURL, that.file = file, that.x_google_ignoreList = x_google_ignoreList, that._computedColumnSpans = !1, that._mappingsPtr = 0, that._wasm = null, wasm().then((w)=>(that._wasm = w, that));
                });
            }
            _findSourceIndex(aSource) {
                let cachedIndex = this._sourceLookupCache.get(aSource);
                if ("number" == typeof cachedIndex) return cachedIndex;
                let sourceAsMapRelative = util.computeSourceURL(null, aSource, this._sourceMapURL);
                if (this._absoluteSources.has(sourceAsMapRelative)) {
                    let index = this._absoluteSources.indexOf(sourceAsMapRelative);
                    return this._sourceLookupCache.set(aSource, index), index;
                }
                let sourceAsSourceRootRelative = util.computeSourceURL(this.sourceRoot, aSource, this._sourceMapURL);
                if (this._absoluteSources.has(sourceAsSourceRootRelative)) {
                    let index = this._absoluteSources.indexOf(sourceAsSourceRootRelative);
                    return this._sourceLookupCache.set(aSource, index), index;
                }
                return -1;
            }
            ...
            _parseMappings() {
                let aStr = this._mappings, size = aStr.length, mappingsBufPtr = this._wasm.exports.allocate_mappings(size) >>> 0, mappingsBuf = new Uint8Array(this._wasm.exports.memory.buffer, mappingsBufPtr, size);
            ...
            eachMapping(aCallback, aContext, aOrder) {
                let context = aContext || null, order = aOrder || SourceMapConsumer.GENERATED_ORDER;
                this._wasm.withMappingCallback((mapping)=>{
                    null !== mapping.source && (mapping.source = this._absoluteSources.at(mapping.source), null !== mapping.name && (mapping.name = this._names.at(mapping.name))), this._computedColumnSpans && null === mapping.lastGeneratedColumn && (mapping.lastGeneratedColumn = 1 / 0), aCallback.call(context, mapping);
                }, ()=>{
                    switch(order){
            ...
            allGeneratedPositionsFor(aArgs) {
                ...
                if (originalLine < 1) throw Error("Line numbers must be >= 1");
                if (originalColumn < 0) throw Error("Column numbers must be >= 0");
                let mappings = [];
            ...
            originalPositionFor(aArgs) {
                ...
                if (needle.generatedLine < 1) throw Error("Line numbers must be >= 1");
                if (needle.generatedColumn < 0) throw Error("Column numbers must be >= 0");
                ...
                if (null == bias && (bias = SourceMapConsumer.GREATEST_LOWER_BOUND), this._wasm.withMappingCallback((m)=>mapping = m, ()=>{
                    ...
                    null !== source && (source = this._absoluteSources.at(source));
            ...
            generatedPositionFor(aArgs) {
                let mapping, source = util.getArg(aArgs, "source");
                if ((source = this._findSourceIndex(source)) < 0) return {
                    line: null,
                    column: null,
                    lastColumn: null
                ...
                if (needle.originalLine < 1) throw Error("Line numbers must be >= 1");
                if (needle.originalColumn < 0) throw Error("Column numbers must be >= 0");
                let bias = util.getArg(aArgs, "bias", SourceMapConsumer.GREATEST_LOWER_BOUND);
                if (null == bias && (bias = SourceMapConsumer.GREATEST_LOWER_BOUND), this._wasm.withMappingCallback((m)=>mapping = m, ()=>{
        ...
        class IndexedSourceMapConsumer extends SourceMapConsumer {
            constructor(aSourceMap, aSourceMapURL){
                return super(INTERNAL).then((that)=>{
                    ...
                    return Promise.all(sections.map((s)=>{
                        if (s.url) throw Error("Support for url field in sections not implemented.");
                        let offset = util.getArg(s, "offset"), offsetLine = util.getArg(offset, "line"), offsetColumn = util.getArg(offset, "column");
                        if (offsetLine < lastOffset.line || offsetLine === lastOffset.line && offsetColumn < lastOffset.column) throw Error("Section offsets must be ordered and non-overlapping.");
            ...
            originalPositionFor(aArgs) {
                let needle = {
                    ...
                    let cmp = aNeedle.generatedLine - section.generatedOffset.generatedLine;
                    return cmp || aNeedle.generatedColumn - (section.generatedOffset.generatedColumn - 1);
            ...
            _findSectionIndex(source) {
                for(let i = 0; i < this._sections.length; i++){
                    let { consumer } = this._sections[i];
                    if (-1 !== consumer._findSourceIndex(source)) return i;
                }
                return -1;
            }
            generatedPositionFor(aArgs) {
                let index = this._findSectionIndex(util.getArg(aArgs, "source")), section = index >= 0 ? this._sections[index] : null, nextSection = index >= 0 && index + 1 < this._sections.length ? this._sections[index + 1] : null, generatedPosition = section && section.consumer.generatedPositionFor(aArgs);
                if (generatedPosition && null !== generatedPosition.line) {
                    let lineShift = section.generatedOffset.generatedLine - 1, columnShift = section.generatedOffset.generatedColumn - 1;
                    return 1 === generatedPosition.line && (generatedPosition.column += columnShift, "number" == typeof generatedPosition.lastColumn && (generatedPosition.lastColumn += columnShift)), generatedPosition.lastColumn === 1 / 0 && nextSection && generatedPosition.line === nextSection.generatedOffset.generatedLine && (generatedPosition.lastColumn = nextSection.generatedOffset.generatedColumn - 2), generatedPosition.line += lineShift, generatedPosition;
                }
                return {
                    line: null,
                    column: null,
            ...
            allGeneratedPositionsFor(aArgs) {
                let index = this._findSectionIndex(util.getArg(aArgs, "source")), section = index >= 0 ? this._sections[index] : null, nextSection = index >= 0 && index + 1 < this._sections.length ? this._sections[index + 1] : null;
                return section ? section.consumer.allGeneratedPositionsFor(aArgs).map((generatedPosition)=>{
                    let lineShift = section.generatedOffset.generatedLine - 1, columnShift = section.generatedOffset.generatedColumn - 1;
                    return 1 === generatedPosition.line && (generatedPosition.column += columnShift, "number" == typeof generatedPosition.lastColumn && (generatedPosition.lastColumn += columnShift)), generatedPosition.lastColumn === 1 / 0 && nextSection && generatedPosition.line === nextSection.generatedOffset.generatedLine && (generatedPosition.lastColumn = nextSection.generatedOffset.generatedColumn - 2), generatedPosition.line += lineShift, generatedPosition;
                }) : [];
            }
            eachMapping(aCallback, aContext, aOrder) {
                this._sections.forEach((section, index)=>{
                    let nextSection = index + 1 < this._sections.length ? this._sections[index + 1] : null, { generatedOffset } = section, lineShift = generatedOffset.generatedLine - 1, columnShift = generatedOffset.generatedColumn - 1;
                    section.consumer.eachMapping(function(mapping) {
                        1 === mapping.generatedLine && (mapping.generatedColumn += columnShift, "number" == typeof mapping.lastGeneratedColumn && (mapping.lastGeneratedColumn += columnShift)), mapping.lastGeneratedColumn === 1 / 0 && nextSection && mapping.generatedLine === nextSection.generatedOffset.generatedLine && (mapping.lastGeneratedColumn = nextSection.generatedOffset.generatedColumn - 2), mapping.generatedLine += lineShift, aCallback.call(this, mapping);
                    }, aContext, aOrder);
                });
            }
            computeColumnSpans() {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/source-map-generator.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class SourceMapGenerator {
            ...
            static fromSourceMap(aSourceMapConsumer) {
                let sourceRoot = aSourceMapConsumer.sourceRoot, generator = new SourceMapGenerator({
                ...
                return aSourceMapConsumer.eachMapping(function(mapping) {
                    ...
                    null != mapping.source && (newMapping.source = mapping.source, null != sourceRoot && (newMapping.source = util.relative(sourceRoot, newMapping.source)), newMapping.original = {
                        line: mapping.originalLine,
                        column: mapping.originalColumn
                    }, null != mapping.name && (newMapping.name = mapping.name)), generator.addMapping(newMapping);
                }), aSourceMapConsumer.sources.forEach(function(sourceFile) {
                    let sourceRelative = sourceFile;
                    null != sourceRoot && (sourceRelative = util.relative(sourceRoot, sourceFile)), generator._sources.has(sourceRelative) || generator._sources.add(sourceRelative);
            ...
            addMapping(aArgs) {
                ...
                this._skipValidation || this._validateMapping(generated, original, source, name), null != source && (source = String(source), this._sources.has(source) || this._sources.add(source)), null != name && (name = String(name), this._names.has(name) || this._names.add(name)), this._mappings.add({
            ...
            applySourceMap(aSourceMapConsumer, aSourceFile, aSourceMapPath) {
                ...
                if (null == aSourceFile) {
                    if (null == aSourceMapConsumer.file) throw Error('SourceMapGenerator.prototype.applySourceMap requires either an explicit source file, or the source map\'s "file" property. Both were omitted.');
                ...
                this._mappings.unsortedForEach(function(mapping) {
                    if (mapping.source === sourceFile && null != mapping.originalLine) {
                        ...
                        null != original.source && (mapping.source = original.source, null != aSourceMapPath && (mapping.source = util.join(aSourceMapPath, mapping.source)), null != sourceRoot && (mapping.source = util.relative(sourceRoot, mapping.source)), mapping.originalLine = original.line, mapping.originalColumn = original.column, null != original.name && (mapping.name = original.name));
                    }
                    ...
                    null != content && (null != aSourceMapPath && (srcFile = util.join(aSourceMapPath, srcFile)), null != sourceRoot && (srcFile = util.relative(sourceRoot, srcFile)), this.setSourceContent(srcFile, content));
                }, this);
            }
            _validateMapping(aGenerated, aOriginal, aSource, aName) {
                if (aOriginal && "number" != typeof aOriginal.line && "number" != typeof aOriginal.column) throw Error("original.line and original.column are not numbers -- you probably meant to omit the original mapping entirely and only map the generated position. If so, pass null for the original mapping instead of an object with empty or null values.");
                if (aGenerated && "line" in aGenerated && "column" in aGenerated && aGenerated.line > 0 && aGenerated.column >= 0 && !aOriginal && !aSource && !aName) ;
                else if (aGenerated && "line" in aGenerated && "column" in aGenerated && aOriginal && "line" in aOriginal && "column" in aOriginal && aGenerated.line > 0 && aGenerated.column >= 0 && aOriginal.line > 0 && aOriginal.column >= 0 && aSource) ;
                else throw Error("Invalid mapping: " + JSON.stringify({
            ...
            _serializeMappings() {
                let next, mapping, nameIdx, sourceIdx, previousGeneratedColumn = 0, previousGeneratedLine = 1, previousOriginalColumn = 0, previousOriginalLine = 0, previousName = 0, previousSource = 0, result = "", mappings = this._mappings.toArray();
            ...
            toJSON() {
                ...
                return null != this._file && (map.file = this._file), null != this._sourceRoot && (map.sourceRoot = this._sourceRoot), this._sourcesContents && (map.sourcesContent = this._generateSourcesContent(map.sources, map.sourceRoot)), map;
            }
            toString() {
                return JSON.stringify(this.toJSON());
            }
        }
        SourceMapGenerator.prototype._version = 3, exports.x = SourceMapGenerator;
    },
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/source-node.js" (__unused_rspack_module, exports, __webpack_require__) {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/util.js" (__unused_rspack_module, exports, __webpack_require__) {
        let URL1 = __webpack_require__("../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/url.js");
        ...
        function isProtoString(s) {
            if (!s) return !1;
            let length = s.length;
            if (length < 9 || 95 !== s.charCodeAt(length - 1) || 95 !== s.charCodeAt(length - 2) || 111 !== s.charCodeAt(length - 3) || 116 !== s.charCodeAt(length - 4) || 111 !== s.charCodeAt(length - 5) || 114 !== s.charCodeAt(length - 6) || 112 !== s.charCodeAt(length - 7) || 95 !== s.charCodeAt(length - 8) || 95 !== s.charCodeAt(length - 9)) return !1;
        ...
        let PROTOCOL = "http:", PROTOCOL_AND_HOST = `${PROTOCOL}//host`;
        function createSafeHandler(cb) {
            return (input)=>{
                let type = getURLType(input), base = buildSafeBase(input), url = new URL1(input, base);
                cb(url);
                let result = url.toString();
                return "absolute" === type ? result : "scheme-relative" === type ? result.slice(PROTOCOL.length) : "path-absolute" === type ? result.slice(PROTOCOL_AND_HOST.length) : computeRelativeURL(base, result);
            };
        }
        ...
        let ABSOLUTE_SCHEME = /^[A-Za-z0-9\+\-\.]+:/;
        function getURLType(url) {
            return "/" === url[0] ? "/" === url[1] ? "scheme-relative" : "path-absolute" : ABSOLUTE_SCHEME.test(url) ? "absolute" : "path-relative";
        }
        function computeRelativeURL(rootURL, targetURL) {
            "string" == typeof rootURL && (rootURL = new URL1(rootURL)), "string" == typeof targetURL && (targetURL = new URL1(targetURL));
            let targetParts = targetURL.pathname.split("/"), rootParts = rootURL.pathname.split("/");
            for(rootParts.length > 0 && !rootParts[rootParts.length - 1] && rootParts.pop(); targetParts.length > 0 && rootParts.length > 0 && targetParts[0] === rootParts[0];)targetParts.shift(), rootParts.shift();
            return rootParts.map(()=>"..").concat(targetParts).join("/") + targetURL.search + targetURL.hash;
        }
        let ensureDirectory = createSafeHandler((url)=>{
            url.pathname = url.pathname.replace(/\/?$/, "/");
        }), trimFilename = createSafeHandler((url)=>{
            url.href = new URL1(".", url.toString()).toString();
        }), normalize = createSafeHandler((url)=>{});
        function join(aRoot, aPath) {
            let pathType = getURLType(aPath), rootType = getURLType(aRoot);
            if (aRoot = ensureDirectory(aRoot), "absolute" === pathType) return withBase(aPath, void 0);
            if ("absolute" === rootType) return withBase(aPath, aRoot);
            if ("scheme-relative" === pathType) return normalize(aPath);
            if ("scheme-relative" === rootType) return withBase(aPath, withBase(aRoot, PROTOCOL_AND_HOST)).slice(PROTOCOL.length);
            if ("path-absolute" === pathType) return normalize(aPath);
            if ("path-absolute" === rootType) return withBase(aPath, withBase(aRoot, PROTOCOL_AND_HOST)).slice(PROTOCOL_AND_HOST.length);
        ...
        exports.join = join, exports.relative = function(rootURL, targetURL) {
            ...
            return sourceRoot && (url = join(sourceRoot, url)), sourceMapURL && (url = join(trimFilename(sourceMapURL), url)), url;
        };
    },
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/wasm.js" (module, __unused_rspack_exports, __webpack_require__) {
        let readWasm = __webpack_require__("../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/read-wasm.js");
        function Mapping() {
    ...
    "../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js" (__unused_rspack_module, exports, __webpack_require__) {
        __webpack_require__("../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/source-map-generator.js").x, exports.YK = __webpack_require__("../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/source-map-consumer.js").YK, __webpack_require__("../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/lib/source-node.js");
    },
    "../../node_modules/.pnpm/statuses@2.0.2/node_modules/statuses/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var codes, map, codes1 = __webpack_require__("../../node_modules/.pnpm/statuses@2.0.2/node_modules/statuses/codes.json");
    ...
    "../../node_modules/.pnpm/supports-color@7.2.0/node_modules/supports-color/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        let forceColor, os = __webpack_require__("os?da1a"), tty = __webpack_require__("tty"), hasFlag = __webpack_require__("../../node_modules/.pnpm/has-flag@4.0.0/node_modules/has-flag/index.js"), { env } = process;
    ...
    "../../node_modules/.pnpm/type-is@2.0.1/node_modules/type-is/index.js" (module, __unused_rspack_exports, __webpack_require__) {
        var contentType = __webpack_require__("../../node_modules/.pnpm/content-type@1.0.5/node_modules/content-type/index.js"), mime = __webpack_require__("../../node_modules/.pnpm/mime-types@3.0.1/node_modules/mime-types/index.js"), typer = __webpack_require__("../../node_modules/.pnpm/media-typer@1.1.0/node_modules/media-typer/index.js");
        function typeis(value, types_) {
            var i, type, types = types_, val = function(value) {
                try {
                    var type;
                    return value ? (type = contentType.parse(value).type, typer.test(type) ? type : null) : null;
                } catch (err) {
                    return null;
                }
            }(value);
            if (!val) return !1;
            if (types && !Array.isArray(types)) for(types = Array(arguments.length - 1), i = 0; i < types.length; i++)types[i] = arguments[i + 1];
        ...
        function mimeMatch(expected, actual) {
            ...
            return 2 === actualParts.length && 2 === expectedParts.length && ('*' === expectedParts[0] || expectedParts[0] === actualParts[0]) && ('*+' === expectedParts[1].slice(0, 2) ? expectedParts[1].length <= actualParts[1].length + 1 && expectedParts[1].slice(1) === actualParts[1].slice(1 - expectedParts[1].length) : '*' === expectedParts[1] || expectedParts[1] === actualParts[1]);
        }
        ...
        }, module.exports.is = typeis, module.exports.hasBody = hasbody, module.exports.normalize = normalize, module.exports.match = mimeMatch;
    },
...
class Socket {
    ...
    saveRequestToMap(api, body = null) {
        ...
        list.some((e)=>e === body || isDeepStrictEqual(e, body)) || list.push(body);
    }
...
async function openBrowser(url, needEncodeURI = !0) {
    if ('darwin' === process.platform || 'win32' === process.platform) try {
        ...
        let { default: open } = await import("./0~open.js");
...
class RsdoctorServer {
    ...
    async bootstrap() {
        ...
        this.app.use(function(dir, opts = {}) {
            ...
            let lookup = opts.dev ? viaLocal.bind(0, dir + external_node_path_sep, isEtag) : viaCache.bind(0, FILES);
            return function(req, res, next) {
                let extns = [
                    ''
                    ...
                    if (raw.length > 1) {
                        ...
                        -1 !== idx && (search = raw.substring(idx), pathname = raw.substring(0, idx), search.length > 1 && (query = __rspack_external_node_querystring_aeb3c0b4.parse(search.substring(1))));
                    }
...
class SDKCore {
    ...
    async writePieces(storeData, _options) {
        ...
        logger.debug(`SDKCore.writePieces extraConfig: ${JSON.stringify(this.extraConfig)}`, '[SDKCore.writePieces]'), this.cloudData = {
            client: {
    ...
    async writeManifest() {
        ...
        return await File.fse.outputFile(tmpPath, dataStr), node_fs.renameSync(tmpPath, diskManifestPath), diskManifestPath;
    }
    ...
    writeToFolder(jsonStr, dir, key, index) {
        let sharding = new File.FileSharding(Algorithm.compressText(jsonStr)), folder = node_path.resolve(dir, key);
...
let source_map = __webpack_require__("../../node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js"), sdk_require = createRequire(import.meta.url);
class RsdoctorSDK extends SDKCore {
    ...
    async bootstrap() {
        logger.debug(`${Date.now()}`, '[RsdoctorSDK][bootstrap start]'), this.server && await this.server.bootstrap(), await super.bootstrap(), logger.debug(`${Date.now()} ${this.server.origin}`, '[RsdoctorSDK][bootstrap end]');
    }
    async dispose() {
        logger.debug(`${Date.now()}`, '[RsdoctorSDK][dispose start]'), this.server && await this.server.dispose(), await super.dispose(), logger.debug(`${Date.now()}`, '[RsdoctorSDK][dispose end]');
    }
    ...
    createPackageGraph() {
        if (logger.debug(`sdk._moduleGraph size: ${this._moduleGraph.size()}`, '[SDK.createPackageGraph][start]'), !this._packageGraph) {
            ...
            this._packageGraph = pkgGraph, logger.debug(`sdk._packageGraph packages: ${this._packageGraph.getPackages().length}`, '[SDK.createPackageGraph][end]');
        }
    }
