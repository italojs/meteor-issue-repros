...
Package["core-runtime"].queue("templating-runtime",function () {/* Imports */
        ...
        for(var i = 0; i < views.length; i++){
            ...
            try {
                if (view === Template.body.view) {
                    ...
                    var _view_dataVar_curValue;
                    Blaze.renderWithData(renderFunc, (_view_dataVar_curValue = view.dataVar.curValue) === null || _view_dataVar_curValue === void 0 ? void 0 : _view_dataVar_curValue.value, parentEl, comment);
                } else {
...
return {
  ...
  require: require,
  eagerModulePaths: [
    "/node_modules/meteor/templating-runtime/templating.js",
    "/node_modules/meteor/templating-runtime/template.dynamic.js",
    "/node_modules/meteor/templating-runtime/dynamic.js"
  ]
}});
