...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
module.export({Random:()=>Random},true);let BrowserRandomGenerator;module.link('./BrowserRandomGenerator',{default(v){BrowserRandomGenerator=v}},0);let createAleaGeneratorWithGeneratedSeed;module.link('./createAleaGenerator',{default(v){createAleaGeneratorWithGeneratedSeed=v}},1);let createRandom;module.link('./createRandom',{default(v){createRandom=v}},2);// We use cryptographically strong PRNGs (window.crypto.getRandomValues())
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
module.export({default:()=>BrowserRandomGenerator});let RandomGenerator;module.link('./AbstractRandomGenerator',{default(v){RandomGenerator=v}},0);
...
return {
  ...
  require: require,
  eagerModulePaths: [
    "/node_modules/meteor/random/main_client.js"
  ],
  mainModulePath: "/node_modules/meteor/random/main_client.js"
}});
